...
class Fishing:
    def __init__(self, delay=0.1, max_step=100, show_det=True): #''', predictor=None'''
        ...
        self.bite = cv2.imread('./components/imgs/bite.png', cv2.IMREAD_GRAYSCALE)
    ...
    def step(self, action):
        ...
        return self.get_state(), self.reward, (self.step_count>self.max_step or (self.zero_count>=2 and self.fish_start) or score>176)
